...
- Visual Studio 2026 Debug、Release重新完整构建，CTest均为2/2；旧Demo `33/33`、正式/V1/V2 `93/93`。
- 新增自动覆盖：长期人物/装备/背包双向同步、阵亡补位、首领性格与外部派系AI、已发布V2旧布局读取、旧正式档只读升级、动画任意键跳过，以及联盟/征服/繁荣/覆灭四条新局纯命令路线。
- 非交互管道继续按设计显示最终静态结局，不等待按键且不输出ANSI控制码；真实交互终端的按键手感留给交换组试玩记录。
