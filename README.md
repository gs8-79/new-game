...
C++17 单机控制台策略游戏。领导燧火部落经营资源、探索16处地点，组织苍林小队，处理六部落外交与战争，在季节结束时决定部落的去向。
...
游戏内：`1`状态、`2`地图、`3`食物、`4`木材、`5`苍林任务、`6`外交、`7`小队、`8`结束季节、`9`帮助。
...
- `expansion_game/expansion_types`：主游戏仍使用的苍林任务、人物、装备、小队和背包。
